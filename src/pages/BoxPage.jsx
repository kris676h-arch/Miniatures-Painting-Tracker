  ...
  return (
    <div style={{ animation:'fadeIn 0.3s ease' }}>
      ...
      <Modal open={detailOpen} onClose={() => setDetailOpen(false)} title={selectedMini?.name || 'Miniature'} large>
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'24px' }}>
          ...
          <div>
            <div
              ...
              style={{
                aspectRatio:'1', background:'var(--bg3)', border:'1px solid var(--border)',
          ...
          <div>
            ...
            <FormGroup label="Noter">
              <textarea
                ...
                placeholder="Farver brugt, fremgang, idéer..."
              />
            </FormGroup>
          </div>
        </div>
        ...
        <style>{`@media(max-width:500px){.mini-detail-grid{grid-template-columns:1fr!important}}`}</style>
  ...
  return (
    ...
    >
      <div style={{ width:'100%', aspectRatio:'1', background:'var(--bg3)', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden', fontSize:'2.5rem' }}>
        {mini.image_url
          ? <img src={mini.image_url} alt={mini.name} style={{ width:'100%', height:'100%', objectFit:'cover' }} />
          : '🎨'
        }
      </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        gap:'8px', aspectRatio:'1', cursor:'pointer', color:'var(--text-dim)',
        transition:'all 0.2s', fontFamily:"'Crimson Text',serif", fontSize:'0.82rem',
      }}
